...
const chatFunction = async (message)=>{
    try {
        ...
        const userMessage = `Please give some customized online security advice based on the following information of the individual in 200 token or less: ${JSON.stringify(message)}`;
